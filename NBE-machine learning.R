...
plot(1-roc.train$specificities, roc.train$sensitivities, #??ѵ��??
     col=blue, xlab="1-Specificity (FPR)", main="", ylab="Sensitivity (TPR)",
     lwd=2, type="l",  xlim=c(0,1),ylim=c(0,1))
lines(x=c(0,1),y=c(0,1),lwd=1.5,lty=2,col="grey40") #????б??
legend("bottomright", bty="n", #????ͼ??
